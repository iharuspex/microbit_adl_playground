package body LM75 is
   ...
   function Read_Register
     (This : LM75_Sensor'Class; Addr : Register_Address) return UInt8;

   function Read_Register
     (This : LM75_Sensor'Class; Addr : Register_Address) return UInt16;

   procedure Write_Register
     (This : LM75_Sensor'Class; Addr : Register_Address; Val : UInt8);

   procedure Write_Register
     (This : LM75_Sensor'Class; Addr : Register_Address; Val : UInt16);
   ...
   --  and hysteresis (Thyst) registers
   --  Shift - 7
   ----------------------------------------------------
   --  MSB                        LSB
   --  7  6  5  4  3  2  1  0  | 7  6  5  4  3  2  1  0
   ...
   function Temp_To_Reg
     (T : Temperature; Scale : Float; Shift : Natural) return UInt16;

   function Reg_To_Temp
     (Reg_Data : UInt16; Scale : Float; Shift : Natural) return Temperature;
   ...
   procedure Set_Address
     (This : in out LM75_Sensor; Device_Address : I2C_Address) is
   begin
   ...
   procedure Set_Hysteresis (This : in out LM75_Sensor; Hyst : Temperature) is
   ...
   procedure Get_Hysteresis (This : in out LM75_Sensor; Hyst : out Temperature)
   is
      Hyst_Raw : UInt16;
   begin
